...
#define DEBUG_STR(txt)           if (_debugEnabled) { Serial.print(F(">")); Serial.println(txt); }

/// Used for Debugging function entries without parameters.
#define DEBUG_VAL(label, val)    if (_debugEnabled) { Serial.print(F(">")); Serial.print(label);  Serial.print(F(":"));  Serial.println(val); }
#define DEBUG_VALX(label, val)    if (_debugEnabled) { Serial.print(F(">")); Serial.print(label);  Serial.print(F(":"));  Serial.println(val, HEX); }

/// Used for Debugging function entries without parameters.
#define DEBUG_FUNC0(fn)          if (_debugEnabled) { Serial.print(F(">")); Serial.print(fn); Serial.println(F("()")); }

/// Used for Debugging function entries with 1 parameter.
#define DEBUG_FUNC1(fn, p1)      if (_debugEnabled) { Serial.print(F(">")); Serial.print(fn); Serial.print(F("(")); Serial.print(p1); Serial.println(F(")")); }

/// Used for Debugging function entries with 1 parameters as hex Value.
#define DEBUG_FUNC1X(fn, p1) if (_debugEnabled) { Serial.print(F(">")); Serial.print(fn); Serial.print(F("(0x")); Serial.print(p1, HEX); Serial.println(F(")")); }

/// Used for Debugging function entries with 2 parameters.
#define DEBUG_FUNC2(fn, p1, p2)  if (_debugEnabled) { Serial.print(F(">")); Serial.print(fn); Serial.print(F("(")); Serial.print(p1); Serial.print(F(", ")); Serial.print(p2); Serial.println(F(")"); }

/// Used for Debugging function entries with 2 parameters and Hex Value.
#define DEBUG_FUNC2X(fn, p1, p2) if (_debugEnabled) { Serial.print(F(">")); Serial.print(fn); Serial.print(F("(0x")); Serial.print(p1, HEX); Serial.print(F(", 0x")); Serial.print(p2, HEX); Serial.println(F(")"); }

...
void RADIO::debugRadioInfo() {
  ...
  Serial.print(F(" - RSSI: ")); Serial.print(info.rssi);
  //Serial.print(F(" SNR: ")); Serial.print(info.snr);
  Serial.println();
} // debugRadioInfo()
...
{
  if (val <= 0x000F) Serial.print(F("0"));     // if less 2 Digit
  if (val <= 0x00FF) Serial.print(F("0"));     // if less 3 Digit
  if (val <= 0x0FFF) Serial.print(F("0"));     // if less 4 Digit
